...
| Setting | Description | Default |
| :-- | :-- | :--: |
| Radio Data System (RDS) standard | Specifies the Radio Data System (RDS) region. When set to __`Automatic`__ the region will be automatically detected. When set to __`World`__ the global RDS standard will be used. When set to __`North America`__ the RBDS standard will be used. | __`Automatic`__ |
